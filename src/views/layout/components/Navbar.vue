<template>
  <div class="navbar">
    ...
    <system-message :visible.sync="sysMessageShow" :unread-nums="unreadNums" :only-announcement="mesOnlyAnnouncement" @update-count="sendSystemUnreadNum" />
    ...
    <nav-manager v-if="navManagerShow" ref="navManager" :collapse="collapse" :top-module="items" @select="navManagerSelect" />
  </div>
</template>
